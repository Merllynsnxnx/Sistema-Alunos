        ...
        <body>
            ...
            <div class="container" id="boletins">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="index02.php">Alunos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="disciplinas.php">Disciplinas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="grafico.php">Gráfico De Médias</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="aprovadosereprovados.php">Aprovados & Reprovados</a>
                        </li>
                        <li class="nav-item">
